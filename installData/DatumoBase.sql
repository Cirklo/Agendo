...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='former mainConfig';
...
(3, 'Reservations', 'Return to reservation system', 1, '../calendar/index.php');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Users registered. You can change your personal data here' AUTO_INCREMENT=4 ;
