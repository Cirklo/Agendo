...
--
-- Host: localhost
-- Generation Time: Mar 14, 2011 at 05:55 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Monitoring boards. <strong>Only used with monitoring system' AUTO_INCREMENT=0 ;
...
--
-- Table structure for table `checkcomments`
--

DROP TABLE IF EXISTS `checkcomments`;
CREATE TABLE IF NOT EXISTS `checkcomments` (
  `checkcomments_id` int(11) NOT NULL AUTO_INCREMENT,
  `checkcomments_user` int(11) DEFAULT NULL,
  `checkcomments_resource` int(11) DEFAULT NULL,
  `checkcomments_datetime` datetime DEFAULT NULL,
  `checkcomments_comment` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `checkcomments_userid` int(3) DEFAULT NULL,
  PRIMARY KEY (`checkcomments_id`),
  KEY `checkcomments_user` (`checkcomments_user`),
  KEY `checkcomments_resource` (`checkcomments_resource`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='User comments per resource responsible' AUTO_INCREMENT=0 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='monitored equipment' AUTO_INCREMENT=0 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='All help content is here.' AUTO_INCREMENT=0 ;
...
DROP TABLE IF EXISTS `hmediaposition`;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table with the available positions for the help media in rel' AUTO_INCREMENT=0 ;
...
DROP TABLE IF EXISTS `hmediatype`;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Types of media available for help' AUTO_INCREMENT=0 ;
...
CREATE TABLE IF NOT EXISTS `mainconfig` (
  ...
  `mainconfig_institute` varchar(100) COLLATE utf8_bin NOT NULL,
  `mainconfig_shortname` varchar(100) COLLATE utf8_bin NOT NULL,
  `mainconfig_url` varchar(100) COLLATE utf8_bin NOT NULL,
  `mainconfig_email` varchar(100) COLLATE utf8_bin NOT NULL,
  `mainconfig_password` varchar(100) COLLATE utf8_bin NOT NULL,
  `mainconfig_host` varchar(100) COLLATE utf8_bin NOT NULL,
  `mainconfig_port` int(11) NOT NULL,
  `mainconfig_smtpsecure` varchar(100) COLLATE utf8_bin NOT NULL,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Allow users only to view specific content' AUTO_INCREMENT=0 ;
...
(2, 'Reservations', 'Return to reservation system', 2, '../index.php'),
(3, 'My calendar', 'Personal calendar', 2, 'mycalendar.php');
...
(1, 'instituteMarker', '3434343', 2, 176, 2);
...
(1, 'adminMarker', 'adminPassMarker', 'adminFirstMarker', 'adminLastMarker', 1, 'adminPhoneMarker', 'adminExtMarker', 'adminMobileMarker', 'adminMailMarker', 1, 0);
...
(1, 'instituteMarker', 'instituteShortMarker', 'instituteUrlMarker', 'instituteMailMarker', 'institutePassMarker', 'instituteHostMarker', institutePortMarker, 'none', 0);
